...
def getVals():
    with open("data/travelRecord.txt","a") as f:
        f.write(f"{nameValue.get(),phoneValue.get(),genderValue.get(),emergancyContactValue.get(),paymentModeValue.get(),foodServiceValue.get()}\n")
